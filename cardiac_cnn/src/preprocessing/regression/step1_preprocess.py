...
def enrich_dicom_csvdata():
    ...
    dicom_data = pandas.read_csv("dicom_data.csv", sep=";")
    ...
    dicom_data.to_csv("dicom_data_enriched.csv", sep=";")

    dicom_data = dicom_data[dicom_data["frame_no"] == 1]
    dicom_data.to_csv("dicom_data_enriched_frame1.csv", sep=";")


def enrich_traindata():
    print("Enriching train data with extra columns and stats")
    train_data = pandas.read_csv("train_validate.csv", sep=",")
    dicom_data = pandas.read_csv("dicom_data_enriched_frame1.csv", sep=";")
    ...
    enriched_traindata.to_csv("train_enriched.csv", sep=",", index=False)
